...
<%@ page language="java" import="uk.co.ambuja.myproject.sax.*" %>
...
try {
    ...
    ParseChangeData handler = new ParseChangeData();
    parser.parse(new InputSource(new StringReader(xmlData)), handler);
        
    ChangeData wsRequest = new ChangeData(handler.getDocument());
